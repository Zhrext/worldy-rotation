...
local function Precombat()
  ...
  if S.SummonWhiteTigerStatue:IsCastable() and CDsON() then
    if Cast(M.SummonWhiteTigerStatue, Settings.Commons.GCDasOffGCD.SummonWhiteTigerStatue, nil, not Target:IsInRange(40)) then return "summon_white_tiger_statue precombat 2"; end
  end
...
local function CDSerenity()
  ...
  if S.SummonWhiteTigerStatue:IsCastable() and (XuenActive) then
    if Cast(M.SummonWhiteTigerStatue, Settings.Commons.GCDasOffGCD.SummonWhiteTigerStatue, nil, not Target:IsInRange(40)) then return "summon_white_tiger_statue cd_serenity 2"; end
  end
...
local function CDSEF()
  -- summon_white_tiger_statue,if=pet.xuen_the_white_tiger.active
  if S.SummonWhiteTigerStatue:IsCastable() and (XuenActive) then
    if Cast(M.SummonWhiteTigerStatue, nil, nil, not Target:IsInRange(40)) then return "summon_white_tiger_statue cd_sef 2"; end
  end
...
local function AutoBind()
  ...
  WR.Bind(M.SummonWhiteTigerStatue)
