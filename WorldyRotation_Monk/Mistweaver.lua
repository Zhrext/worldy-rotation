...
local Settings = {
  ...
  Mistweaver = WR.GUISettings.APL.Monk.Mistweaver
}
...
local function Init()
  --WR.Print("Mistweaver rotation is currently a work in progress, but has been updated for patch 9.1.5.")
end

WR.SetAPL(270, APL, Init)
